                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="card">
                         <div class="el-card-item">
                             <div class=" el-overlay-1"><a href="{{url('program/photo/'.$gallery->id)}}"><img src="{{asset('image/gallery/'.$gallery->image)}}" alt="user" /></a>
{{--                                 <div class="">--}}
{{--                                     <ul class="el-info">--}}
...
{{--                                 </div>--}}
                             ...
                             <div class="el-card-content">
                                 <h3 class="box-title"><a href="{{url('program/photo/'.$gallery->id)}}">{{$gallery->program}}</a></h3>
                                 <br/> </div>
                         </div>
                     </div>
                 </div>
